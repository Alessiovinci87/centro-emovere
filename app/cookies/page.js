    ...
    <section className="section">
      <div className="container">
        ...
        <div className="prose prose-neutral max-w-3xl mt-10">
          ...
          <p>Il sito di {site.brand} utilizza esclusivamente cookie tecnici e strumenti strettamente necessari al suo funzionamento, che non richiedono consenso ai sensi dell&apos;art. 122 del Codice Privacy e delle Linee guida del Garante del 10 giugno 2021. L&apos;unico cookie impostato direttamente dal sito è quello, eventuale, che ricorda l&apos;accesso alla versione in anteprima riservata all&apos;équipe.</p>
